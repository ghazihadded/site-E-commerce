...
const orderRules = () => [
  body("shippingInfo.address", "enter your correct adress ")
    .notEmpty()
    .isLength({ max: 50 }),
  body("shippingInfo.city", "enter your correct city ")
    .notEmpty()
    .isLength({ max: 20 }),
  body("shippingInfo.phone", "enter your correct phone ")
    .notEmpty()
    .isLength({ max: 10 }),
  body("shippingInfo.postalCode", "enter your correct postal Code ")
    .notEmpty()
    .isLength({ max: 20 }),
  body("shippingInfo.country", "enter your correct country ")
    .notEmpty()
    .isLength({ max: 20 }),
];
