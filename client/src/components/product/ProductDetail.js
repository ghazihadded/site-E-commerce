...
import { getProductsById,createReviews } from "../../actions/productsAction";
...
const ProductDetail = ({ match }) => {
  ...
  const { productLoading, product } = useSelector(
  ...
  const handleSubmit=()=>{
    ...
    dispatch(createReviews(product._id,{comment,rating}))
  }
